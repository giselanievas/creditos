                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="concesionaria" type="text" class="form-control @error('concesionaria') is-invalid @enderror" name="concesionaria" value="{{ old('concesionaria') }}" required autocomplete="concesionaria" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="localidad" type="text" class="form-control @error('concesionaria') is-invalid @enderror" name="localidad" value="{{ old('localidad') }}" required autocomplete="localidad" autofocus>
